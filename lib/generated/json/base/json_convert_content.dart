...
class JsonConvert {
  static final Map<String, JsonConvertFunction> convertFuncMap = {
    ...
    (VideoResponseEntity).toString(): VideoResponseEntity.fromJson,
  };
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<VideoResponseEntity>[] is M) {
      return data
          .map<VideoResponseEntity>(
              (Map<String, dynamic> e) => VideoResponseEntity.fromJson(e))
          .toList() as M;
    }
